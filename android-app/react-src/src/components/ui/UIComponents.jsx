  ...
  return (
    <header className="sanctuary-header dissipatable">
      ...
      <div className="header-nav-icons">
        ...
        {/* EYE TOGGLE DISSIPATE BUTTON */}
        <button
          className={`nav-icon-btn eye-toggle-btn ${isDissipated ? 'dissipated-active' : ''}`}
          onClick={(e) => { e.stopPropagation(); toggleDissipate(); }}
          title={isDissipated ? "Restore Sanctuary UI (Tap to View)" : "Hide UI Cards / View 3D Background (Tap to Dissipate)"}
        >
          {isDissipated ? (
